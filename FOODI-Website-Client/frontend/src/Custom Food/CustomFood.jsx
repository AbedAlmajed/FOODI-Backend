...
//       Swal.fire({
//         title: 'Error!',
//         text: error.response?.data?.message || 'Failed to submit custom dish. Please try again.',
//         icon: 'error',
//         confirmButtonText: 'OK'
//       });
//     }
...
//           headers: { Authorization: `Bearer ${token}` }
//         });
//         Swal.fire('Deleted!', 'Your custom dish item has been deleted.', 'success');
//         fetchApprovedCustomItems(token, userId);
//       } catch (error) {
...
//       <main className="flex-1 flex flex-col items-center p-6 mt-20">
//         <div className="bg-white shadow-lg rounded-lg w-full max-w-lg p-8 mb-8">
//           <h1 className="text-3xl font-bold text-gray-900 mb-4 text-center">Add Custom Dish</h1>
//           <form className="space-y-6 mt-8" onSubmit={handleSubmit}>
...
//       <h2 className="text-center text-2xl font-bold mb-6">Approved Custom Dish Items</h2>
