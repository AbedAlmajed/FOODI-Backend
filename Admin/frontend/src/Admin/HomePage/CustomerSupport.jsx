...
//         `http://localhost:5000/api/contacts?page=${currentPage}&limit=${ITEMS_PER_PAGE}&search=${searchTerm}`
//       );
//       setContacts(response.data);
//     } catch (error) {
//       console.error('Error fetching contacts:', error);
...
//   const fetchTotalContacts = useCallback(async () => {
//     try {
//       const response = await axios.get(`http://localhost:5000/api/contacts/messages/count?search=${searchTerm}`);
//       setTotalContacts(response.data.count);
//     } catch (error) {
//       console.error('Error fetching total contacts:', error);
//     }
...
//       }
//     };
//   }, [fetchContacts, fetchTotalContacts, searchTerm]);
...
//                 className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green"
//               />
...
const CustomerSupport = () => {
  ...
  const fetchTotalContacts = useCallback(async () => {
    try {
      const response = await axios.get(`http://localhost:5000/api/contacts/messages/count?name=${nameSearch}`);
      setTotalContacts(response.data.count);
    } catch (error) {
      console.error('Error fetching total contacts:', error);
    }
