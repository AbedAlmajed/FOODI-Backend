...
//    <>
//    <Sidebar/>
//    <div>Driverccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc</div>
//    </>
//   )
// }
...
//     try {
//       await axios.put(`http://localhost:5000/api/drivers/${id}/toggle-approval`);
...
//                 <td className="border p-2">{driver.isApproved ? 'Approved' : 'Not Approved'}</td>
//                 <td className="border p-2">
//                   <button
//                     onClick={() => toggleApproval(driver._id)}
          ...
          <tbody>
            {drivers.map((driver) => (
              <tr key={driver._id} className="hover:bg-gray-100">
                ...
                <td className="border p-2">
                  <button
                    onClick={() => toggleApproval(driver._id, driver.isApproved)}
                    className={`px-4 py-2 rounded ${
                      driver.isApproved
                        ? 'bg-red text-white hover:bg-red'
                        : 'bg-green text-white hover:bg-green'
